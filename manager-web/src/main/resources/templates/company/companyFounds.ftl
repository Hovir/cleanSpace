...
<nav class="breadcrumb"><i class="Hui-iconfont"></i>
    ...
    <span class="c-999 en">&gt;</span><span class="c-666">企业收益</span></nav>
...
<#--            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加用户','${path}/page/company/companyListAddEdit','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <td>1</td>
                        <td><u style="cursor:pointer;text-decoration:none;" class="text-primary" onclick="member_show('张三','${path}/page/company/companyFoundsShow','10001','400','450')">张三</u></td>
                        <td>1体验店</td>
                        <td>13000000000</td>
                        <td>2014-6-11 11:11:42</td>
                        <td class="td-status"><span class="label label-success radius">已启用</span></td>
                        <td><a title="详情" href="javascript:;" onclick="member_edit('详情','${path}/page/company/companyFoundsShow','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe665;</i>详情</a></td>
                        <td>测试</td>
                    </tr>
                    </tbody>
                </table>
