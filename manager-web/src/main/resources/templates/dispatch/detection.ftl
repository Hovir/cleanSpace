...
<nav class="breadcrumb"><i class="Hui-iconfont"></i>
    ...
    <span class="c-999 en">&gt;</span><span class="c-666">派遣检测</span>
    <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:;" onclick="pageTurns('dispatch/detection')" title="刷新" >
...
<div class="Hui-article">
    ...
    <#--请在下方写此页面业务相关的脚本-->
        ...
        <script type="application/javascript">
            var url = "${path}/findAllOrderByType?type=1";
            /*列对应表*/
            var columns = [
                {data: "id"},
                {data: "name"},
