...
(function (factory) {
   ...
   * @class core.list
   *
   * listActivities.jsp utils
   *
   * @singleton
   * @alternateClassName listActivities.jsp
   */
  var list = (function () {
    /**
    ...
    /**
     * returns true if the value is present in the listActivities.
     */
    ...
    /**
     * returns whether listActivities is empty or not
     */
  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      lists: {
        unordered: 'Unordered listActivities',
        ordered: 'Ordered listActivities'
      },
      options: {
        help: 'Help',
      ...
      help: {
        ...
        'insertUnorderedList': 'Toggle unordered listActivities',
        'insertOrderedList': 'Toggle ordered listActivities',
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
      ...
      // isOnList: judge whether range is on listActivities node or not
  ...
  var Style = function () {
    ...
    this.current = function (rng) {
      ...
      // listActivities.jsp-style-type to listActivities.jsp-style(unordered, ordered)
      if (!rng.isOnList()) {
  ...
  var Bullet = function () {
    ...
    /**
     * toggle unordered listActivities
     */
    ...
    this.toggleList = function (listName, editable) {
      ...
      if (list.find(paras, dom.isPurePara)) {
        ...
        paras = wrappedParas;
      // listActivities.jsp to paragraph or change listActivities.jsp style
      } else {
    ...
    this.wrapList = function (paras, listName) {
      ...
      // append to listActivities(<ul>, <ol>)
  ...
  var HelpDialog = function (context) {
    ...
    this.createShortCutList = function () {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = $('<div><div class="help-listActivities-item"/></div>');
